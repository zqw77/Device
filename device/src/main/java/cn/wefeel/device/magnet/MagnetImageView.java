package cn.wefeel.device.magnet;
 ...
 * 自定义ImageView视图
 */
public class MagnetImageView extends android.support.v7.widget.AppCompatImageView {
	...
	public MagnetImageView(Context context, AttributeSet attrs, int defStyle)
	{
		...
		public void handleMessage(android.os.Message msg)
		{
			...
			switch (msg.what)
			{
				...
				case SCALING:
					...
					{
						isFinish = true;
						if (MagnetImageView.this.mOnViewClickListener != null && !isClicked)
						{
							isClicked = true;
							MagnetImageView.this.mOnViewClickListener.onViewClick(MagnetImageView.this);
						} else
						{
							isClicked = false;
						}
	...
	{
		void onViewClick(MagnetImageView view);
	}
}
